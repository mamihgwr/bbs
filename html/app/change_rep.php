<?php //返信の編集投稿フォーム
//edit_rep.phpからchange_rep.phpにきてフォーム入力→送信後はthanks_rep.phpへ
//session_start();
...
$num = [];
    ...
    if (count($err) > 0 && $delete_key !=='delete_key') {
      // 未入力返す
      $_SESSION['err']  = $err;
      $_SESSION['num']  = $num;
...
<html>
    <div align="center">      
        <body>   
            <form action="thanks_rep.php" method="post" enctype="multipart/form-data">
