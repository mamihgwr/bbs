<?php
 //返信のthanxページ
    ...
    if($_SERVER['REQUEST_METHOD']==='POST'){
       ...
       //データベースへreplies行を追加する
       $sql = ("insert into replies (board_id,name,subject,message,image_path,email,url,text_color,delete_key)
       values('{$id}','{$name}','{$subject}','{$message}','{$uploaded_path}','{$email}','{$url}','{$text_color}','{$delete_key}')");
    ?>
<html>
    <div align="center">
